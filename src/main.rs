//! AlgoTom GridRec optimizer — tune the AlgoTom GridRec reconstruction parameters on two test
...
use algotom_gridrec_optimizer::app::OptimizerApp;

const USAGE: &str = "\
algotom_gridrec_optimizer — tune AlgoTom GridRec parameters on two test slices

USAGE:
  algotom_gridrec_optimizer [OPTIONS] [CHECKPOINT.h5]
...
OPTIONS:
  --called-from-app   Driven by another application: saving the parameters
                      also prints the algotom_gridrec_config JSON on stdout
...
fn main() -> eframe::Result<()> {
    ...
    let native_options = eframe::NativeOptions {
        viewport: egui::ViewportBuilder::default()
            ...
            .with_title("AlgoTom GridRec Optimizer"),
        ..Default::default()
    };
    eframe::run_native(
